...
#"$DEFAULT_EXECUTION" export lg_id=lg_test_1;  export simulation_name=my_simulation_test_1; export env=debug_env_test_1; export test_type=debug_test_1; export build_id=build_test_1; export environment=https://challengers.flood.io; export duration=121; export ramp_duration=120; export ramp_users=5;java -jar build/libs/gatling-example-1.0-SNAPSHOT-all.jar FloodIoJava
#"$DEFAULT_EXECUTION" export lg_id=lg_test_1;  export simulation_name=my_simulation_test_1; export env=debug_env_test_1; export test_type=debug_test_1; export build_id=build_test_1; export environment=https://challengers.flood.io; export duration=121; export ramp_duration=120; export ramp_users=5;java -jar gatling-example-1.0-SNAPSHOT-all.jar FloodIoJava
#"$DEFAULT_EXECUTION" java -jar gatling_demo_scripts/gatling-example-1.0-SNAPSHOT-all.jar FloodIoJava
#"$DEFAULT_EXECUTION" java $JAVA_OPTS -jar gatling_demo_scripts/gatling-example-1.0-SNAPSHOT-all.jar FloodIoJava
#"$DEFAULT_EXECUTION" export lg_id=lg_test_1;  export simulation_name=my_simulation_test_1; export env=debug_env_test_1; export test_type=debug_test_1; export build_id=build_test_1; export environment=https://challengers.flood.io; export duration=121; export ramp_duration=120; export ramp_users=5;java -jar ./../gatling-example-1.0-SNAPSHOT-all.jar FloodIoJava
#"$DEFAULT_EXECUTION" export lg_id=lg_test_1;  export simulation_name=my_simulation_test_1; export env=debug_env_test_1; export test_type=debug_test_1; export build_id=build_test_1; export environment=https://challengers.flood.io; export duration=121; export ramp_duration=120; export ramp_users=5;java -jar ./../carrier.Flood FloodIoJava
#"$DEFAULT_EXECUTION" export lg_id=lg_test_1;  export simulation_name=my_simulation_test_1; export env=debug_env_test_1; export test_type=debug_test_1; export build_id=build_test_1; export environment=https://challengers.flood.io; export duration=121; export ramp_duration=120; export ramp_users=5;java -jar ./../demo.demo_executable.jar FloodIoJava
#"$DEFAULT_EXECUTION" export lg_id=${lg_id};  export simulation_name=${simulation_name}; export env=${env}; export test_type=${test_type}; export environment=${environment}; export duration=${duration}; export ramp_duration=${ramp_duration}; export ramp_users=${ramp_users};java -jar ./../demo.demo_executable.jar FloodIoJava
#"$DEFAULT_EXECUTION" "$JAVA_OPTS" -jar ./../demo.demo_executable.jar FloodIoJava > a.txt 2>&1
#"$DEFAULT_EXECUTION" $JOLOKIA_AGENT -jar ./../demo.demo_executable.jar FloodIoJava > a.txt 2>&1
"$DEFAULT_EXECUTION" $JOLOKIA_AGENT $DEFAULT_JAVA_OPTS $JAVA_OPTS  -jar ./../demo.demo_executable.jar FloodIoJava > a.txt 2>&1
#export JAVA_OPTS="-Dsimulation_name= -Denv= -D -Dbuild_id=${build_id} -Dlg_id=${lg_id} -Dgatling.http.ahc.pooledConnectionIdleTimeout=150000 -Dgatling.http.ahc.readTimeout=150000 -Dgatling.http.ahc.requestTimeout=150000 -Dgatling.data.writers.0=console -Dgatling.data.writers.1=file -Dcharting.indicators.lowerBound=2000 -Dcharting.indicators.higherBound=3000 ${GATLING_TEST_PARAMS}"
#"$DEFAULT_EXECUTION" java $JAVA_OPTS -jar ./../gatling-example-1.0-SNAPSHOT-all.jar FloodIoJava
#"$DEFAULT_EXECUTION" java -jar ./../gatling-example-1.0-SNAPSHOT-all.jar FloodIoJava
sleep 60s
